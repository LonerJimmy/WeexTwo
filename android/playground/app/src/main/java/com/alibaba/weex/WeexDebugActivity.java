...
public class WeexDebugActivity extends AppCompatActivity implements IWXHttpAdapter.OnHttpListener {
    ...
    public void onHttpFinish(WXResponse response) {
        if ("200".equals(response.statusCode)) {
            ...
            if (framework != null) {
                WXSDKEngine.reload(WeexDebugActivity.this, framework, false);
                finish();
                return;
            }
        }
